...
<html lang="en">
    ...
    <body>
        ...
        <header class="header header--2">
            ...
            <h2 class="heading--4">Sindh</h2>
            <div class=".animated-line animated-line animated-line-sindh"></div>
        </header>        
        <!-- -------------------------------- BODY ------------------------------- -->

        <section class="cities">
            <ul class="cities__list">
                <li><a href="bhitshah.php">bhitshah</a></li>
                <li><a href="hyderabad.php">Hyderabad</a></li>
                <li><a href="../../notavailable.php">Islamkot</a></li>
                <li><a href="../../notavailable.php">Larkana</a></li>
                <li><a href="../../notavailable.php">Karachi</a></li>
                <li><a href="../../notavailable.php">Mithi</a></li>
                <li><a href="../../notavailable.php">Nagarparkar</a></li>
                <li><a href="../../notavailable.php">Rohri</a></li>
                <li><a href="../../notavailable.php">Sehwan</a></li>
                <li><a href="../../notavailable.php">Sukkur</a></li>
                <li><a href="../../notavailable.php">ShaheedBenazirabad</a></li>
                <li><a href="../../notavailable.php">TandoAdam</a></li>
                <li><a href="../../notavailable.php">Thatta</a></li>
            </ul>
        </section>
