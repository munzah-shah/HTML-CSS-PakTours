...
<html lang="en">
    ...
    <body>
        ...
        <header class="header header--2">
            ...
            <h2 class="heading--4">Balochistan</h2>
            <div class="animated-line animated-line-balochistan"></div>
        </header>        
        <!-- -------------------------------- BODY ------------------------------- -->
        ...
        <section class="cities">
            <ul class="cities__list">
                ...
                <li><a href="gwadar.php">Gwadar</a></li>
                <li><a href="pasni.php">Pasni</a></li>
                <li><a href="../../notavailable.php">Lasbela</a></li>
                <li><a href="../../notavailable.php">Quetta</a></li>
                <li><a href="../../notavailable.php">Ziarat</a></li>
                <li><a href="../../notavailable.php">Khuzdar</a></li>
                <li><a href="../../notavailable.php">Bolan</a></li>
                <li><a href="../../notavailable.php">Turbat</a></li>
                <li><a href="../../notavailable.php">Kharan</a></li>
                <li><a href="../../notavailable.php">Chaman</a></li>
            </ul>
        </section>
